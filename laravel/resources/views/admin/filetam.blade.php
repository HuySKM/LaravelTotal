    ...
    <div class="row">
        <div class="form-three widget-shadow">
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="focusedinput" class="col-sm-2 control-label">desc</label>
                    <div class="col-sm-8">
                        <input type="text" name="desc" class="form-control1" id="focusedinput" placeholder="Default Input">
                    </div>
                </div>
                <div class="form-group">
                    <label for="focusedinput" class="col-sm-2 control-label">Intro</label>
                    <div class="col-sm-8">
                        <input type="text" name="intro" class="form-control1" id="focusedinput" placeholder="Default Input">
                    </div>
                </div>
                <div class="form-group">
